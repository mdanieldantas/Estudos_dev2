console.log(7 / 0) // qualquer numero dividido por 0gera infinito
console.log('10' / 2) //
console.log('10' + 2) // ele vai concatenar por causa da string 10 pois + faz sentido pro mundo d string
console.log('show!' * 2)
