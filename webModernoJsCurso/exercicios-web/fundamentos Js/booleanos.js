...
isAtivo = 1
console.log(!!isAtivo) // o sinal de Exclamacão para Js é interpretado como negativo "! "
console.log(!isAtivo)// ao colocar 1 sinal de negativo antes da variavel você tem um negativo você transforma em negativo
console.log('os verdadeiros...')
console.log(!!3) // ao colocar 2 sinais de negativo antes você tem um positivo
