function compras(trabalho1, trabalho2) {
    const comprarSorvete = trabalho1 || trabalho2// OR (||): Retorna verdadeiro se pelo menos uma das expressões for verdadeira. se um deles der certo tomo sorvete
    const comprarTv50 = trabalho1 && trabalho2//AND (&&): Retorna verdadeiro se ambas as expressões forem verdadeiras. só se os dois trabalhos derem certo.
    //const comprarTv32 = !!(trabalho1ˆtrabalho2)
    const comprarTv32 = trabalho1 != trabalho2 // !=diferente
    const manterSaudavel = !comprarSorvete// operador unario, não comprar o sorvete e se manter saldavel, egacão lógica 

    return { comprarSorvete: comprarSorvete, comprarTv50: comprarSorvete, comprarTv32: comprarSorvete, manterSaudavel: manterSaudavel }
