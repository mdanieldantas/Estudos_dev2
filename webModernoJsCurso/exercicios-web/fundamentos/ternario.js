const resultado = nota => nota >= 7 ? 'Aprovado' : 'Reprovado'// condição nota >=7 , sendo maior retona aprovado, sendo menor volta reprovado, é utilizado o : dividir as condiçoes
...
maiorIdade = prompt('coloque sua nota: ')
